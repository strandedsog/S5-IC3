...
function startGame(){
    ...
    var turn = document.getElementById("turnID").value;
    if (turn == "Hurakan"){
        document.getElementById('id2').style.backgroundColor='white';
        document.getElementById('id1').style.backgroundColor ='#ffb6c1';
    }else{
        document.getElementById('id1').style.backgroundColor='white';
        document.getElementById('id2').style.backgroundColor='#ffb6c1';
    }    
        ...
        if(openedCards[0].type === openedCards[1].type){
            matched();
                if (turn == "Hurakan"){
                    ...
                    if (turn == "Hurakan"){
                        document.getElementById("turnID").value = "Sinaloa";
                        document.getElementById('id1').style.backgroundColor='white';
                        document.getElementById('id2').style.backgroundColor='#ffb6c1';
                    }else{
                        document.getElementById("turnID").value = "Hurakan";
                        document.getElementById('id2').style.backgroundColor='white';
                        document.getElementById('id2').style.backgroundColor ='#ffb6c1';                        
                    }
        } else {
